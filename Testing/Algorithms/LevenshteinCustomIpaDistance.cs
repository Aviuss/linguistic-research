...
{   
    phylogenetic_project.Persistance.IpaCustomLetterDistance ipaDict = new(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..", "..", "..", "..", @"data and results", "json settings", "ipa_letter_distance.csv"));
