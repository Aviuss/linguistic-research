...
{   
    phylogenetic_project.Persistance.IpaLetterDistance ipaDict = new(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..", "..", "..", "..", @"data and results", "json settings", "ipa_letter_distance.csv"));
